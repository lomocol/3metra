...
/* Статусы мест по полам ведём вручную и только когда они действительно
   известны. Сейчас на 26 сентября открыта запись для всех, у вечера 35+
   идёт предзапись — строки в карточках заданы прямо в разметке */
const AVAILABILITY = {};
...
/* time: "" — время вечера ещё не объявлено (предзапись), в подтверждении
   его не показываем и предупреждаем, что дату назовёт администратор */
const EVENTS = {
  sep26: { label: "суббота, 26 сентября", group: "группа 23–35 лет, бар-ресторан GasGas", time: "19:30" },
  sep35m: { label: "конец сентября", group: "группа 35+, бар-ресторан GasGas", time: "" },
};
