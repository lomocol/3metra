...
/* На «Продай друга» мест по полам не считаем — строка статуса со страницы
   убрана. Для обычных вечеров сюда возвращается запись вида
   sep13: { f: "open", m: "open" } и разметка [data-availability] */
const AVAILABILITY = {};
