...
const EVENTS = {
  aug29: { label: "суббота, 29 августа", group: "группа 22–35 лет, 15 пар", time: "19:00" },
};

/* Женские места разобраны: продаём только мужские. Цена единая */
